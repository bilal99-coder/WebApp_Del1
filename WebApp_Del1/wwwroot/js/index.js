...
// Funksjon som oppgir havner-til når kunden laster nettsiden 
...
function oppdaterPris() {
    //Vise prisen 
    $("#pris").css("display", "block");

    let valgteAkomstHavnen__Id;
    let pris = 0;
    ...
    console.log(" iden valgte ankomstHavnen er " + valgteAkomstHavnen__Id);

    //Kall på ajax for prisen til valgte ankomst havnen 
...
function beregnTotalPris(response) {
    ...
    totalPrisen = totalPrisen + (rutePrisen * antallVoksne);

    // Barn betaler halv prisen 

    //totalPrisen +=  (rutePrisen *antallBarn) / 2;
